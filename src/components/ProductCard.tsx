...
const ProductCard = ({ product }: { product: ProductType }) => {
  ...
  console.log(productTypes, setProductTypes);
  return (
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="flex items-center gap-2">
              {product.colors.map((color) => (
                <div
                  className={`w-4.25 h-4.25 rounded-full cursor-pointer border-2 ${productTypes.color === color ? "border-gray-400" : "border-gray-200"} rounded-full p-[1.2px]`}
                  key={color}
                  onClick={() =>
